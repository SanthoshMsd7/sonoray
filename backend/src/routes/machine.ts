...
router.post('/', authenticate, authorize(['ADMIN', 'SUPER_ADMIN', 'SALES_MANAGER']), createMachine);
router.put('/:id', authenticate, authorize(['ADMIN', 'SUPER_ADMIN', 'SERVICE_MANAGER', 'SALES_MANAGER']), updateMachine);
